package com.cuize.activity.utils;
...
public class LoggerUtil {
	...
	public static String getCallerClass2() {
		for (StackTraceElement e : Thread.currentThread().getStackTrace()) {
			if (!"java.lang.Thread".equals(e.getClassName()) && !e.getClassName().equals(LoggerUtil.class.getName()))
	 ...
	 * @param e
	 */
	public static void warn(final Class<?> clazz, final String msg, final Exception e) {
		Logger logger = getLogger(clazz);
		logger.warn(msg, e);
	}
	 ...
	 * @param e
	 */
	public static void warn(final String loggerName, final String msg, final Exception e) {
		Logger logger = getLogger(loggerName);
		logger.warn(msg, e);
	}
	 ...
	 * @param e
	 */
	public static void error(final Class<?> clazz, final String msg, final Exception e) {
		Logger logger = getLogger(clazz);
		logger.error(msg, e);
	}
	 ...
	 * @param e
	 */
	public static void error(final String loggerName, final String msg, final Exception e) {
		Logger logger = getLogger(loggerName);
		logger.error(msg, e);
	}
}