 ...
 * @requires jQuery,EasyUI
 */
com.sirius.skymall.user.onMove = {
...
$.extend($.fn.dialog.defaults, com.sirius.skymall.user.onMove);
$.extend($.fn.window.defaults, com.sirius.skymall.user.onMove);
$.extend($.fn.panel.defaults, com.sirius.skymall.user.onMove);
 ...
 * @requires jQuery,EasyUI
 */
com.sirius.skymall.user.onLoadError = {
...
$.extend($.fn.datagrid.defaults, com.sirius.skymall.user.onLoadError);
$.extend($.fn.treegrid.defaults, com.sirius.skymall.user.onLoadError);
$.extend($.fn.tree.defaults, com.sirius.skymall.user.onLoadError);
$.extend($.fn.combogrid.defaults, com.sirius.skymall.user.onLoadError);
$.extend($.fn.combobox.defaults, com.sirius.skymall.user.onLoadError);
$.extend($.fn.form.defaults, com.sirius.skymall.user.onLoadError);
 ...
 * 
 */
com.sirius.skymall.user.loadFilter = {
...
$.extend($.fn.combotree.defaults, com.sirius.skymall.user.loadFilter);
$.extend($.fn.tree.defaults, com.sirius.skymall.user.loadFilter);
 ...
 * 
 */
com.sirius.skymall.user.modalDialog = function(options) {
	var opts = $.extend({
		title : '&nbsp;',
		width : 640,
		height : 480,
 ...
 * @param themeName
 */
com.sirius.skymall.user.changeTheme = function(themeName) {
	...
	com.sirius.skymall.user.cookie('easyuiTheme', themeName, {
		expires : 7
	});
};
 ...
 * @requires jQuery,EasyUI
 */
com.sirius.skymall.user.progressBar = function(options) {
