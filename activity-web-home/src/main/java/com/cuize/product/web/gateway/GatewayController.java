package com.cuize.product.web.gateway;
...
public class GatewayController {
	...
	static {
		methodProviderMap.put("product.ticket.queryTicketList", "/queryTicketList");
		methodProviderMap.put("product.ticket.draw", "/draw");
		methodProviderMap.put("product.ticket.validateDraw", "/validateDraw");
		methodProviderMap.put("product.ticket.queryTicketDetail", "/queryTicketDetail");
	}
