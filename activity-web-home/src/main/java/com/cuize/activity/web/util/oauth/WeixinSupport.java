...
public class WeixinSupport {
    ...
    static {
        ...
        returnCodeMap.put(9001037,"单个设备绑定页面不能超过30个");
        returnCodeMap.put(9001038,"设备总数超过了限额");
        returnCodeMap.put(9001039,"不合法的联系人名字");
        returnCodeMap.put(9001040,"不合法的联系人电话");
        returnCodeMap.put(9001041,"不合法的联系人邮箱");
        returnCodeMap.put(9001042,"不合法的行业id");
        returnCodeMap.put(9001043,"不合法的资质证明文件url，文件需通过“素材管理”接口上传");
        returnCodeMap.put(9001044,"缺少资质证明文件");
        returnCodeMap.put(9001045,"申请理由不能超过500字");
        returnCodeMap.put(9001046,"公众账号未认证");
        returnCodeMap.put(9001047,"不合法的设备申请批次id");
        returnCodeMap.put(9001048,"审核状态为审核中或审核已通过，不能再提交申请请求");
